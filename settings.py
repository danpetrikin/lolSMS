...
DATABASES = {
    'default': {
        ...
        'NAME': 'lol2ez',                      # Or path to database file if using sqlite3.
...
FACEBOOK_REQUEST_PERMISSIONS = 'user_about_me,user_education_history,user_hometown,user_online_presence,user_photos,email'

# django-registration
ACCOUNT_ACTIVATION_DAYS = 7
EMAIL_HOST = 'localhost'
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
DEFAULT_FROM_EMAIL = 'admin@lol2ez.com'
